var library = {
    pokemonFeu: [
      ...
      'https://img.pokemondb.net/sprites/home/normal/1x/volcanion.png',
      'https://img.pokemondb.net/sprites/black-white/normal/ho-oh.png',
      'https://img.pokemondb.net/sprites/black-white/normal/ninetales.png',
    ...
    pokemonEau: [
      ...
      'https://img.pokemondb.net/sprites/black-white/normal/samurott.png',
      'https://img.pokemondb.net/sprites/black-white/normal/seismitoad.png',
      'https://img.pokemondb.net/sprites/bank/normal/greninja.png',
    ...
    pokemonElectrique: [
        ...
        'https://img.pokemondb.net/sprites/black-white/normal/galvantula.png',
        'https://img.pokemondb.net/sprites/black-white/normal/eelektross.png',
        'https://img.pokemondb.net/sprites/x-y/normal/heliolisk.png',
        'https://img.pokemondb.net/sprites/bank/normal/tapu-koko.png',
        'https://img.pokemondb.net/sprites/bank/normal/zeraora.png',
        'https://img.pokemondb.net/sprites/diamond-pearl/normal/raichu-f.png',
        'https://img.pokemondb.net/sprites/diamond-pearl/normal/electabuzz.png',
        'https://img.pokemondb.net/sprites/diamond-pearl/normal/jolteon.png',
        'https://img.pokemondb.net/sprites/diamond-pearl/normal/ampharos.png',
  ...
  function activateTheme(theme) {
    ...
    for (let i = 0; i < 30; i++) {images.push(library[theme][i]);}  
