    ...
    <header>
        ...
        <div id="container">
            ...
            <div class="container2">
                ...
                <div class="container2-texte">
                    <div class="container2-div1">
                        <h1>310</h1>
                        <p><strong>Parties jouées</strong></p>
                    </div>
                    <div class="container2-div2">
                        <h1>1020</h1>
                        <p><strong>Joueurs connectés</strong></p>
                    </div>
                    <div class="container2-div3">
                        <h1>10sec</h1>
                        <p><strong>Temps record</strong></p>
                    </div>
                    <div class="container2-div4">
                        <h1>21 300</h1>
